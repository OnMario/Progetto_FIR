...
#
# Generated by Vivado on Thu Jul 23 11:03:20 +0200 2026
...
set_property -name "top" -value "tb_axi_system_fsm" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
cr_bd_synth_top ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files synth_top.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files synth_top.bd ] 
set_property IS_ENABLED "1" [get_files synth_top.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files synth_top.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files synth_top.bd ] 
set_property PFM_NAME "" [get_files synth_top.bd ] 
...
set_property USED_IN "synthesis implementation simulation" [get_files synth_top.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files synth_top.bd ] 
set_property USED_IN_SIMULATION "1" [get_files synth_top.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files synth_top.bd ] 
...
set_property -name "lib_map_file" -value "" -objects $obj
set_property -name "loop_count" -value "1000" -objects $obj
set_property -name "name" -value "design_1_inst_0" -objects $obj
...
set_property -name "lib_map_file" -value "" -objects $obj
set_property -name "loop_count" -value "1000" -objects $obj
set_property -name "name" -value "design_1_inst_1" -objects $obj
set_property -name "target_constrs_file" -value "" -objects $obj
