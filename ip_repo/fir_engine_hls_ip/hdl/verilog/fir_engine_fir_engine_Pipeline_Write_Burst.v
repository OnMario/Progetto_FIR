...
module fir_engine_fir_engine_Pipeline_Write_Burst (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln51_fu_95_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln51_fu_95_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln51_fu_101_p2 = (ap_sig_allocacmp_i_1 + 5'd1);
...
assign icmp_ln51_fu_95_p2 = ((ap_sig_allocacmp_i_1 == 5'd26) ? 1'b1 : 1'b0);

assign local_out_address0 = zext_ln51_fu_107_p1;
...
assign m_axi_gmem0_0_WDATA = local_out_load_reg_144;
...
assign zext_ln51_fu_107_p1 = ap_sig_allocacmp_i_1;

endmodule //fir_engine_fir_engine_Pipeline_Write_Burst
